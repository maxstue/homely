<template>
<svg :width="getWidth" :height="getHeight" viewBox="0 0 300 300" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
    <rect x="0" y="0" width="300" height="300" style="fill:none;"/>
    <g transform="matrix(10.5712,0,0,10.5712,-19.1396,-19.1429)">
    ...
    <defs>
        <linearGradient id="_Linear1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(19.9388,9.2976,-9.2976,19.9388,-0.962498,13.8951)"><stop offset="0" style="stop-color:rgb(78,26,112);stop-opacity:1"/><stop offset="1" style="stop-color:rgb(43,76,242);stop-opacity:1"/></linearGradient>
        <linearGradient id="_Linear2" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(25.3771,11.8336,-11.8336,25.3771,0.967093,2.65777)"><stop offset="0" style="stop-color:rgb(78,26,112);stop-opacity:1"/><stop offset="1" style="stop-color:rgb(43,76,242);stop-opacity:1"/></linearGradient>
        <linearGradient id="_Linear3" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(8.23969,3.84223,-3.84223,8.23969,2.34095,22.0688)"><stop offset="0" style="stop-color:rgb(78,26,112);stop-opacity:1"/><stop offset="1" style="stop-color:rgb(43,76,242);stop-opacity:1"/></linearGradient>
        <linearGradient id="_Linear4" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(12.0733,5.62985,-5.62985,12.0733,1.69549,18.463)"><stop offset="0" style="stop-color:rgb(78,26,112);stop-opacity:1"/><stop offset="1" style="stop-color:rgb(43,76,242);stop-opacity:1"/></linearGradient>
    </defs>
</svg>
</template>
